  ...
  implements MenuBuilder.Callback, com.actionbarsherlock.view.Window.Callback, MenuPresenter.Callback, MenuItem.OnMenuItemClickListener
{
  ...
  private void installDecor()
  {
    ...
    if ((0x1 & this.mUiOptions) != 0)
    {
      ...
      label374: ActionBarContainer localActionBarContainer = (ActionBarContainer)this.mDecor.findViewById(R.id.abs__split_action_bar);
    ...
    while (true)
    {
      this.mDecor.post(new Runnable()
      {
        public void run()
        {
          if ((!ActionBarSherlockCompat.this.mActivity.isFinishing()) && (ActionBarSherlockCompat.this.mMenu == null))
  ...
  private boolean preparePanel()
  {
    ...
    while (true)
    {
      ...
      if (this.mMenu == null)
      {
        boolean bool2 = initializePanelMenu();
        j = 0;
        if (!bool2)
          continue;
    ...
    label134: this.mMenu.stopDispatchingItemsChanged();
  ...
  public boolean dispatchKeyEvent(KeyEvent paramKeyEvent)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        {
          return j;
          if ((this.aActionBar != null) && (this.wActionBar.hasExpandedActionView()))
          {
            if (n == 1)
    ...
    while (k != 1);
    boolean bool2 = this.mMenuKeyIsLongPress;
    int m = 0;
    if (!bool2)
      if (this.mActionMode == null)
      {
    ...
    while (true)
    {
      ...
      return m;
      label178: this.wActionBar.showOverflowMenu();
    }
  }
    ...
    implements ActionMode.Callback
  {
    ...
    public void onDestroyActionMode(ActionMode paramActionMode)
    {
      ...
      ActionBarSherlockCompat.access$402(ActionBarSherlockCompat.this, null);
    }
