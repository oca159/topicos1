  ...
  implements Animator.AnimatorListener
{
  ...
  public void initForMode(ActionMode paramActionMode)
  {
    ...
    if (this.mClose == null)
    {
      ...
      addView(this.mClose);
      this.mClose.findViewById(R.id.abs__action_mode_close_button).setOnClickListener(new View.OnClickListener(paramActionMode)
      {
    ...
    if (this.mContentHeight > 0)
    {
      ...
      if (this.mCustomView != null)
      {
        ...
        if (localLayoutParams.height == -2)
          break label456;
        i8 = 1073741824;
        label334: if (localLayoutParams.height < 0)
          break label464;
      }
    }
    int i2;
    label441: label449: label456: label464: for (int i9 = Math.min(localLayoutParams.height, n); ; i9 = n)
    {
