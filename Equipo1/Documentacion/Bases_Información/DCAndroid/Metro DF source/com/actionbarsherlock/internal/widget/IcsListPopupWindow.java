...
public class IcsListPopupWindow
{
  ...
  private int buildDropDown()
  {
    ...
    if (this.mDropDownList == null)
    {
      ...
      if (!this.mModal)
      {
        ...
        default:
          ...
          label268: Drawable localDrawable = this.mPopup.getBackground();
          j = 0;
    ...
    label476: int m = measureHeightOfChildren(0, 0, -1, k - i, -1);
    if (m > 0)
      i += j;
    return m + i;
  }
  ...
  public void show()
  {
    ...
    if (this.mPopup.isShowing())
    {
      ...
      if (this.mDropDownWidth == i)
      {
        ...
        if (this.mDropDownWidth != i)
          break label141;
        label66: localPopupWindow2.setWindowLayoutMode(i, 0);
      }
      while (true)
      {
        ...
        label141: i = 0;
        break label66;
        label146: PopupWindow localPopupWindow1 = this.mPopup;
        ...
        continue;
        label181: if (this.mDropDownHeight == -2)
        {
          i1 = j;
          continue;
        }
    ...
    while (true)
    {
      ...
      k = 0;
      break label216;
      label371: if (this.mDropDownHeight == -2)
      {
