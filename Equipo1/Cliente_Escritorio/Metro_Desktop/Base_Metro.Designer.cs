...
namespace Metro_Desktop
{
    ...
    /// </summary>
    public partial class Entidades_Metro : ObjectContext
    {
        #region Constructors
    
        /// <summary>
        /// Initializes a new Entidades_Metro object using the connection string found in the 'Entidades_Metro' section of the application configuration file.
        /// </summary>
        public Entidades_Metro() : base("name=Entidades_Metro", "Entidades_Metro")
        {
        ...
        /// <summary>
        /// Initialize a new Entidades_Metro object.
        /// </summary>
        public Entidades_Metro(string connectionString) : base(connectionString, "Entidades_Metro")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new Entidades_Metro object.
        /// </summary>
        public Entidades_Metro(EntityConnection connection) : base(connection, "Entidades_Metro")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="Equipo1_Modelo", Name="horarios")]
    [Serializable()]
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="Equipo1_Modelo", Name="rutas")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
